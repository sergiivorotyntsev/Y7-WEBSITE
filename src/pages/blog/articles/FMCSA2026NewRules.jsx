...
export default function FMCSA2026NewRules() {
  return (
    <article style={{ maxWidth: 780, margin: '0 auto' }}>
      <p style={{ marginBottom: 18, fontSize: '1.02rem', lineHeight: 1.8, color: 'var(--v2-ink, #050607)' }}>
        On <strong style={{ color: 'var(--v2-ink, #050607)' }}>January 16, 2026</strong>, a set of FMCSA
      ...
      <h2 style={{ fontFamily: 'var(--v2-font-display)', fontSize: 'clamp(1.15rem, 2.2vw, 1.35rem)', fontWeight: 600, letterSpacing: '0.04em', textTransform: 'uppercase', color: 'var(--v2-ink, #050607)', margin: '36px 0 16px' }}>
      ...
      <p style={{ marginBottom: 18, fontSize: '1.02rem', lineHeight: 1.8, color: 'var(--v2-ink, #050607)' }}>
        ...
        <strong style={{ color: 'var(--v2-ink, #050607)' }}>$75,000</strong> (a BMC-84 bond or BMC-85 trust),
      ...
      <p style={{ marginBottom: 18, fontSize: '1.02rem', lineHeight: 1.8, color: 'var(--v2-ink, #050607)' }}>
        ...
        window to <strong style={{ color: 'var(--v2-ink, #050607)' }}>7 days</strong>. For brokerages operating
      ...
      <div style={{ border: '1px solid rgba(5, 6, 7, 0.14)', padding: '16px 24px', margin: '24px 0', background: 'var(--v2-card-cream, #fffaf1)', borderRadius: 12, fontStyle: 'italic', color: 'var(--v2-ink, #050607)' }}>
      ...
      <p style={{ marginBottom: 18, fontSize: '1.02rem', lineHeight: 1.8, color: 'var(--v2-ink, #050607)' }}>
        ...
        within <strong style={{ color: 'var(--v2-ink, #050607)' }}>2 business days</strong>. Previously, the
      ...
      <p style={{ marginBottom: 18, fontSize: '1.02rem', lineHeight: 1.8, color: 'var(--v2-ink, #050607)' }}>
        ...
        <strong style={{ color: 'var(--v2-ink, #050607)' }}> $12,882</strong> per violation, and repeated
        non-compliance can result in a <strong style={{ color: 'var(--v2-ink, #050607)' }}>3-year ban</strong> from
      ...
      <div style={{ background: 'var(--v2-card-cream, #fffaf1)', border: '1px solid rgba(5, 6, 7, 0.14)', borderRadius: 12, padding: '20px 24px', margin: '24px 0' }}>
        <div style={{ fontWeight: 500, fontFamily: "var(--font-mono, 'JetBrains Mono', monospace)", color: 'var(--v2-ink-muted, #5c5851)', marginBottom: 8, fontSize: '0.72rem', letterSpacing: '0.14em', textTransform: 'uppercase' }}>Key Takeaway</div>
        <p style={{ margin: 0, fontSize: '0.95rem', lineHeight: 1.7, color: 'var(--v2-ink, #050607)' }}>
      ...
      <p style={{ marginBottom: 18, fontSize: '1.02rem', lineHeight: 1.8, color: 'var(--v2-ink, #050607)' }}>
        ...
        <strong style={{ color: 'var(--v2-ink, #050607)' }}> $100,000 or more</strong> to provide adequate
