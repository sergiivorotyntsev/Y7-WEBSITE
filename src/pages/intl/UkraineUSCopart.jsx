// UkraineUSCopart.jsx
// Route: /ua-us/copart-shipping
// Template B: Copart Guide
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://www.y7agency.com/ua-us/copart-shipping',
    },
  ],
};

// TODO-UA-US: Replace with real Copart vs IAAI comparison data
...
// TODO-UA-US: Replace with real fee descriptions
const fees = [
...
// TODO-UA-US: Replace with real route descriptions (US domestic routes)
const routes = [
...
// TODO-UA-US: Replace with real pitfall descriptions
const pitfalls = [
...
// TODO-UA-US: Replace with real document checklist items
const documentChecklist = [
  { label: 'PLACEHOLDER_DOC_1_LABEL', desc: 'PLACEHOLDER_DOC_1_DESC' },
  { label: 'PLACEHOLDER_DOC_2_LABEL', desc: 'PLACEHOLDER_DOC_2_DESC' },
  { label: 'PLACEHOLDER_DOC_3_LABEL', desc: 'PLACEHOLDER_DOC_3_DESC' },
  { label: 'PLACEHOLDER_DOC_4_LABEL', desc: 'PLACEHOLDER_DOC_4_DESC' },
  { label: 'PLACEHOLDER_DOC_5_LABEL', desc: 'PLACEHOLDER_DOC_5_DESC' },
];

// TODO-UA-US: Replace with real step descriptions
const howItWorks = [
...
const UkraineUSCopart = () => {
  return (
    <div style={pageStyle}>
      <Helmet>
        {/* TODO-UA-US: Replace PLACEHOLDER meta with real Ukrainian SEO content */}
        <title>PLACEHOLDER_META_TITLE</title>
        <meta name="description" content="PLACEHOLDER_META_DESCRIPTION" />
        <link rel="canonical" href="https://www.y7agency.com/ua-us/copart-shipping" />
        <html lang="uk" />
      ...
      >
        ...
        >
          ...
          <li><Link to="/ua-us" style={{ color: '#993C1D', textDecoration: 'none' }}>PLACEHOLDER_BREADCRUMB_PARENT</Link></li>
          <li style={{ color: '#999' }}>/</li>
      ...
      >
        {/* TODO-UA-US: Replace with Ukrainian H1 headline */}
        <h1 style={{ ...h1Style, marginBottom: '1.5rem' }}>
          PLACEHOLDER_H1
        </h1>

        {/* TODO-UA-US: Replace with Ukrainian lead paragraph */}
      ...
      <section style={sectionStyle}>
        {/* TODO-UA-US: Replace with Ukrainian section title */}
        <h2 style={h2Style}>PLACEHOLDER_DOCS_H2</h2>
        <p style={{ ...pStyle, marginBottom: '2rem' }}>
          PLACEHOLDER_DOCS_INTRO
        </p>
          ...
          {documentChecklist.map((doc, i) => (
            ...
            >
              ...
              <div>
                ...
                <p style={{ ...pStyle, fontSize: '0.9rem', margin: 0 }}>{doc.desc}</p>
              </div>
            </div>
          ))}
        </div>
...
export default UkraineUSCopart;
