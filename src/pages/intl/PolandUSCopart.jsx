...
export default function PolandUSCopart() {
  return (
    <>
      <Helmet>
        <title>Copart w USA — odbior i transport | Y7 Logistics</title>
        <meta name="description" content="Odbior aut z Copart i transport miedzy stanami USA. Obsluga po polsku." />
        <html lang="pl" />
      ...
      <main id="main" style={{ padding: '2rem 1.5rem', maxWidth: 800, margin: '0 auto', fontFamily: 'Georgia, serif' }}>
        <h1>Copart w USA — odbior i transport</h1>
        <p style={{ fontStyle: 'italic', color: '#666' }}>[S5-TODO] Content coming in next session. Infrastructure placeholder.</p>
        <p>Specjalizujemy sie w transporcie aut z aukcji Copart do dowolnego stanu w USA.</p>
      </main>
    </>
  );
}
