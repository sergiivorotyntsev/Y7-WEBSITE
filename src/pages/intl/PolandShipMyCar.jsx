...
// =============================================================================
// PolandShipMyCar.jsx — Template C (Action/Ordering)
// Route: /pl/ship-my-car
// Audience: Poland (import to Poland), co-brand Y7 + DaytonaCargo
...
// TODO-PL: Replace all PLACEHOLDER strings with real Polish content
const faqSchema = {
...
// Breadcrumb: Home -> Sprowadzanie aut -> Ship My Car (this page)
...
function PolandShipMyCar() {
  return (
    <div style={pageStyle} lang="pl">
      ...
      {/* TODO-PL: Replace with compelling Polish hero copy for import to PL  */}
      {/* Co-brand: Y7 + DaytonaCargo                                        */}
      {/* ================================================================== */}
      <section style={{ ...sectionStyle, paddingTop: 'clamp(3rem, 8vw, 6rem)' }}>
        ...
        <p style={{ ...pStyle, marginTop: '1.5rem', maxWidth: '720px' }}>
          {/* ~80 words placeholder lead paragraph about ordering car import to Poland */}
      ...
      {/* TODO-PL: Replace checklist items with real requirements             */}
      {/* ================================================================== */}
      ...
      {/* TODO-PL: Replace step titles and descriptions                      */}
      {/* ================================================================== */}
      <section style={sectionStyle}>
        <h2 style={h2Style}>
      ...
      {/* TODO-PL: Replace contact heading and descriptive text              */}
      {/* ================================================================== */}
      <section style={sectionStyle}>
        <h2 style={h2Style}>
      ...
      {/* TODO-PL: Replace pricing heading and card content                  */}
      {/* ================================================================== */}
      <section style={sectionStyle}>
        <h2 style={h2Style}>
      ...
      {/* TODO-PL: Replace trust heading and descriptions                    */}
      {/* ================================================================== */}
      <section style={sectionStyle}>
        <div
          style={{
      ...
      {/* TODO-PL: Replace FAQ questions and answers                         */}
      {/* ================================================================== */}
      <section style={sectionStyle}>
        <h2 style={h2Style}>
      ...
      {/* ================================================================== */}
      {/* SECTION 7 — Dark CTA                                               */}
      {/* TODO-PL: Replace CTA heading, text, and button label               */}
      {/* ================================================================== */}
      <section
        style={{
          ...darkCtaStyle,
