// UkraineUSShipMyCar.jsx
// Route: /ua-us/ship-my-car
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://www.y7agency.com/ua-us/ship-my-car',
    },
  ],
};

// TODO-UA-US: Replace with real checklist items for ordering prerequisites
...
// TODO-UA-US: Replace with real ordering workflow steps
const workflowSteps = [
...
// TODO-UA-US: Replace with real common mistakes
...
// TODO-UA-US: Replace with real pricing tiers for US domestic routes
const pricingTiers = [
  ...
  return (
    <div style={pageStyle}>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.y7agency.com/ua-us/ship-my-car" />
        <html lang="uk" />
      ...
      >
        ...
        {/* TODO-UA-US: Replace with Ukrainian lead paragraph (~80 words) */}
        <p
          style={{
            ...pStyle,
            maxWidth: '700px',
      ...
      {/* ============================================================ */}
      {/*  CONTACT SECTION (US domestic - no DaytonaCargo)             */}
      {/* ============================================================ */}
      <section style={sectionStyle}>
        {/* TODO-UA-US: Replace with Ukrainian section title */}
...
export default UkraineUSShipMyCar;
