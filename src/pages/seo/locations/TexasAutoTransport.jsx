    ...
    <SeoLandingPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: 'Yes. Every carrier we dispatch carries minimum $750,000 cargo insurance — most carry $1M+. We verify active coverage through Central Dispatch before assigning any load. Your BOL at pickup and delivery is the formal record for any claim against the carrier\u2019s policy.',
        },
      ]}
      related={[
